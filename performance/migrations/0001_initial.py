# Generated by Django 3.2.6 on 2021-09-13 07:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('performance', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='performanceVideo', to='performance.performance')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='performance',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='userPerformance', to=settings.AUTH_USER_MODEL),
        ),
    ]
